...
class Scroller(object):
	...
	def add_buildings(self):
		current_place = 0
		while current_place < self.width: 
			self.add_building(current_place)
			current_place += self.build_list[-1].width + 20
	...
	def add_building(self, x_location):
		...
		building = Building(x_location, self.height, random.randint(10,50), random.randint(500,700), self.color) 
		self.build_list.append(building) 
